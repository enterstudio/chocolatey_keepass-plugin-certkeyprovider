...
$packageName = 'keepass-plugin-certkeyprovider'
$packageSearch = 'KeePass Password Safe'
$url = 'https://github.com/markbott/CertKeyProvider/releases/download/1.0.0/CertKeyProviderPlugin.plgx'
$checksum = '241D2642F29774B582AFDED020BA02CC63ADC14DEC277040412ACD93992B6D7B'
$checksumType = 'sha256'
